佳音娘娘請翻牌 (Who Will the Queen Joy Choose Tonight?)

### [點擊這裡開始翻牌 (Play Game)](https://stormpotion.github.io/cjy-to-joy-card-game/)

---

關於這個專案 (About)
*This game is dedicated to Joy.* ❤️
...
使用技術 (Tech Stack)
* HTML5
* CSS3 (Flexbox, Grid, 3D Transform)
* Vanilla JavaScript (No libraries used)

---
*Created with love by Ching-Ju Yang.*
